...
import logo from "../res_images/ips_logo.png";
                ...
                <MDBContainer>
                  <MDBCol md="12" className="text-center">
                    <MDBIcon
                      ...
                      style={{ color: "#119aea" }}
                    />
                    <h4>Indian Public School ,Suhili</h4>
                    <h6>Fees Recept</h6>
                  </MDBCol>
                </MDBContainer>
          ...
          <MDBContainer>
            <MDBCol md="12" className="text-center">
              <MDBIcon
                ...
                style={{ color: "#5d9fc5" }}
              />
              <p className="pt-0">IndianPublicSchool.com</p>
            </MDBCol>
          </MDBContainer>
          <MDBRow>
            <MDBCol xl="8">
            ...
            <MDBCol xl="4">
              ...
              <MDBTypography listUnStyled>
                ...
                <li className="text-muted">
                  <MDBIcon fas icon="circle" style={{ color: "#e6f7ff" }} />
